  ...
  return (
    <>
      ...
      <div className="mb-4 flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
        <div>
          <p className="text-sm font-semibold text-brand-600">Official PAO Intake Form</p>
        ...
        <div className="flex flex-wrap gap-2">
          <div className="inline-flex rounded-lg border border-line bg-card p-1">
            <button
              ...
              className={`rounded px-3 py-1.5 text-sm font-semibold ${
                language === "english" ? "bg-brand-600 text-white" : "text-gray-600"
              }`}
            >
              English
            </button>
            <button
              ...
              className={`rounded px-3 py-1.5 text-sm font-semibold ${
                language === "filipino" ? "bg-brand-600 text-white" : "text-gray-600"
              }`}
            >
              Filipino
            </button>
          ...
          <Link
            to="/criminal-cases"
            className="rounded-lg border border-line bg-card px-4 py-2 text-sm font-semibold text-gray-600 hover:bg-parchment-100"
          >
            Back to Cases
          </Link>
        </div>
      ...
      {isLoading ? (
        <div className="h-[720px] animate-pulse rounded-lg bg-gray-200" />
      ) : data && printableData ? (
        language === "english" ? (
