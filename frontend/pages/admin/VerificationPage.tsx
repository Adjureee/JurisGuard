...
const statusClass: Record<ApprovalStatus, string> = {
  ...
  under_review: "bg-parchment-100 text-gray-600 ring-slate-300",
  approved: "bg-green-100 text-green-700 ring-green-700/25",
  rejected: "bg-red-100 text-red-800 ring-red-600/20",
  suspended: "bg-gray-200 text-gray-800 ring-gray-400/30",
};
    ...
    <MainLayout>
      <PageHeader
        ...
        actions={
          ...
          <select
            ...
            className="h-10 rounded-lg border border-parchment-300 bg-card px-3 text-sm text-gray-800 outline-none transition focus:border-brand-600 focus:ring-2 focus:ring-brand-600/20"
          >
      ...
      <section className="rounded-xl border border-line bg-card shadow-sm">
        ...
        <div className="grid gap-3 p-4 md:hidden">
          {isLoading ? (
            <div className="rounded-lg border border-line bg-parchment-100 px-4 py-8 text-center text-sm text-gray-500">
              ...
              >
                ...
                <div className="mt-4 flex items-center justify-between gap-3">
                  ...
                  <button
                    ...
                    className="rounded-lg border border-gray-900 bg-card px-3 py-2 text-xs font-semibold text-gray-900 transition hover:bg-gray-900 hover:text-white"
                  >
                    View
                  </button>
                </div>
                ...
                {!isFinalStatus(user.approval_status) && (
                  <div className="mt-4 grid grid-cols-2 gap-2">
                    ...
                    <button
                      ...
                      disabled={updatingId === user.user_id}
                      className="min-h-10 rounded-lg border border-red-600 bg-card px-3 py-2 text-sm font-semibold text-red-700 transition hover:bg-red-600 hover:text-white disabled:cursor-not-allowed disabled:opacity-60"
                    >
                      Reject
                    </button>
                  </div>
        ...
        <div className="hidden overflow-x-auto md:block">
          <table className="w-full min-w-[760px] text-sm">
            <thead className="sticky top-0 z-10 border-b border-line bg-parchment-100 text-xs uppercase tracking-wide text-gray-500">
              <tr>
                        ...
                        {!isFinalStatus(user.approval_status) && (
                          <>
                            ...
                            <button
                              ...
                              disabled={updatingId === user.user_id}
                              className="rounded-lg border border-red-600 bg-card px-3 py-1.5 text-xs font-semibold text-red-700 transition hover:bg-red-600 hover:text-white disabled:cursor-not-allowed disabled:opacity-60"
                            >
                              Reject
                            </button>
                          </>
      ...
      {selectedUser && (
        ...
        <div className="jurisguard-modal-overlay bg-black/70 backdrop-blur-sm" role="dialog" aria-modal="true">
          <div className="jurisguard-modal-surface max-h-[92vh] w-full max-w-5xl animate-[modalIn_200ms_ease-out] overflow-hidden rounded-2xl border border-line bg-card shadow-xl">
            <div className="sticky top-0 z-10 flex items-start justify-between gap-4 border-b border-line bg-parchment-100 px-6 py-4">
              <div>
              ...
              <button
                ...
                className="flex h-9 w-9 items-center justify-center rounded-full border border-line bg-card text-sm font-semibold text-gray-600 transition duration-200 hover:bg-parchment-100 hover:text-gray-800"
            ...
            <div className="max-h-[calc(92vh-74px)] overflow-y-auto bg-card">
              <div className="grid gap-6 p-6 lg:grid-cols-[1fr_340px]">
                ...
                <aside className="rounded-xl border border-line bg-parchment-100 p-4">
                  <h3 className="text-sm font-semibold text-gray-800">
                    Employee ID
                  </h3>
                  <div className="mt-4 overflow-hidden rounded-xl border border-line bg-card">
                    {employeeIdEvidence.imageSrc ? (
                      ...
                      <div className="flex h-64 flex-col items-center justify-center gap-2 px-4 text-center text-sm text-gray-600">
                ...
                {!isFinalStatus(selectedUser.approval_status) && (
                  <>
                    ...
                    <button
                      ...
                      disabled={updatingId === selectedUser.user_id}
                      className="min-h-10 rounded-lg border border-red-600 bg-card px-4 py-2 text-sm font-semibold text-red-700 transition hover:bg-red-600 hover:text-white disabled:cursor-not-allowed disabled:opacity-60"
                    >
                      Reject
                    </button>
                  </>
