        ...
        <div className="flex min-h-[580px] items-center justify-center px-6 py-8 sm:px-10 lg:px-16">
          ...
          >
            ...
            <form onSubmit={handleLogin} className="space-y-4">
              ...
              <AnimatePresence initial={false}>
                {showMfaCode && (
                  <motion.div
                    ...
                    className="rounded-xl border border-slate-200 bg-parchment-100/80 p-4 shadow-sm"
                  >
                    ...
                    <label className="block">
                      ...
                      <input
                        ...
                        inputMode="numeric"
                        maxLength={6}
                        className="mt-1.5 h-12 w-full rounded-lg border border-slate-300 bg-card px-4 text-center font-mono text-lg font-semibold tracking-[0.35em] text-slate-950 outline-none transition-all duration-200 ease-in-out placeholder:tracking-normal placeholder:text-slate-400 focus:border-brand-600 focus:ring-4 focus:ring-brand-600/10"
                        value={otpCode}
                        onChange={(event) =>
                          setOtpCode(
              ...
              {notice && (
                <div className="rounded-lg border border-slate-200 bg-parchment-100 px-3 py-2 text-sm font-medium text-slate-700 shadow-sm">
                  {notice}
                </div>
              )}
