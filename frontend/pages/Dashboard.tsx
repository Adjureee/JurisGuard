      ...
      fallback={
        <div className="flex min-h-screen items-center justify-center bg-parchment-100 px-4">
          <div className="max-w-md rounded-xl border border-line bg-card p-6 text-center shadow-pop">
            <p className="text-base font-semibold text-gray-800">Dashboard temporarily unavailable</p>
            <p className="mt-2 text-sm text-gray-600">The rest of JurisGuard is still available from the sidebar.</p>
            <button
              type="button"
      ...
      <Suspense
        fallback={
          <div className="flex min-h-screen flex-col items-center justify-center gap-3 bg-parchment-100">
            ...
            />
            <p className="text-sm font-semibold text-gray-600">Loading dashboard intelligence...</p>
          </div>
        }
      >
