    ...
    <ErrorBoundary
      ...
      fallback={
        <div className="flex min-h-screen items-center justify-center bg-[#F9FAFB] px-4">
          <div className="max-w-md rounded-xl border border-[#E5E7EB] bg-white p-5 text-center shadow-xl ">
            <p className="text-base font-semibold text-[#2B3642]">Dashboard temporarily unavailable</p>
