...
function createClusterIcon(total: number, terminated: number) {
  const color = terminated > 0 && terminated === total ? "#DC2626" : "#2E486F";
  return L.divIcon({
    className: "",
...
export default function GeoAnalyticsMap({
  ...
  return (
    <div className="relative z-0 overflow-hidden rounded-lg border border-line bg-card shadow-sm">
      <div className="flex flex-wrap items-center justify-between gap-3 border-b border-line bg-parchment-100 px-4 py-3">
        <div>
            ...
            >
              <Popup>
                <div className="min-w-52">
                  ...
                  <p className="text-xs text-gray-600">{barangay.city}</p>
                  <div className="mt-3 grid grid-cols-3 gap-2 text-center">
                    <div className="rounded-lg bg-brand-50 p-2">
                      <p className="text-base font-bold text-brand-600">
                        {barangay.total_cases}
                      </p>
                      <p className="text-[10px] uppercase text-brand-700">
                        Total
                      </p>
                    </div>
                    <div className="rounded-lg bg-brand-50 p-2">
                      ...
                      <p className="text-[10px] uppercase text-brand-600">
                        Active
                      </p>
                    </div>
                    <div className="rounded-lg bg-red-100 p-2">
                      ...
                      <p className="text-[10px] uppercase text-red-800">
                        Closed
                      </p>
                    </div>
                  </div>
              ...
              >
                ...
                <Popup>
                  <div className="min-w-56">
                    ...
                    <div className="mt-3 rounded-lg border border-line bg-parchment-100 p-3">
