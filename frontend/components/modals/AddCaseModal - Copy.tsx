...
export default function AddCaseModal({ isOpen, onClose }: AddCaseModalProps) {
  ...
  return (
    <div className="jurisguard-modal-overlay bg-[#111827]/30 backdrop-blur-sm transition-opacity duration-200">
      <div className="jurisguard-modal-surface max-h-[92vh] w-full max-w-6xl animate-[modalIn_200ms_ease-out] overflow-hidden rounded-lg border border-[#E5E7EB] bg-white shadow-2xl shadow-[#111827]/10">
