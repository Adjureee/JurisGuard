          ...
          <div className="border-b border-line bg-parchment-100 px-6 py-5">
            <div className="flex items-center justify-between gap-4">
              ...
              <button
                type="button"
                onClick={closeModal}
                className="rounded-lg px-3 py-1.5 text-sm font-medium text-gray-600 transition duration-200 hover:bg-gray-200 hover:text-gray-800"
              >
                Close
              </button>
            </div>
          ...
          {phase === "case" && createdClient ? (
            ...
            >
              ...
              <div className="flex-1 overflow-y-auto bg-card px-6 py-5">
                ...
                {method === "camera" && (
                  <div className="mb-5 rounded-lg border border-line bg-parchment-100 p-4">
                    <div className="grid gap-4 lg:grid-cols-[1fr_280px]">
                      <video
                        ref={videoRef}
                        muted
                        playsInline
                        className="aspect-video w-full rounded-lg border border-line bg-parchment-100 object-cover"
                      />
                      <div className="space-y-3">
                        ...
                        <button
                          type="button"
                          onClick={stopCamera}
                          className="w-full rounded-lg border border-line bg-card px-4 py-2 text-sm font-semibold text-gray-600 hover:bg-parchment-100"
                        >
                          Stop Camera
                        </button>
                        <button
                          ...
                          className="w-full rounded-lg border border-brand-600 bg-card px-4 py-2 text-sm font-semibold text-brand-600 hover:bg-brand-50 hover:text-brand-700 disabled:opacity-50"
                        >
                ...
                {method === "upload" && (
                  <div className="mb-5 rounded-lg border border-dashed border-line bg-parchment-100 p-4">
                    <label className="block">
